    ...
    <div class="cols">
      <div>
        ...
        <p class="small mt3" style="color:rgba(255,255,255,.7);max-width:38ch">
          We are the publishing arm of Exceptional Companies &mdash; a family office in Colorado
          Springs where we buy, build, and operate exceptional businesses across advisory, energy,
...
<section class="hero">
  ...
  <div class="wrap">
    ...
    <h1 class="display mt3">Everything<br>we publish.</h1>
    <hr class="accentrule wide mt4">
    <p class="lead mt4">Books, podcasts, and a quarterly magazine for people who are building
      something worth keeping &mdash; and who intend to hand it off well.</p>
    <div class="btnrow mt4">
...
<section class="section section--tight section--rule">
  <div class="wrap">
    ...
    <p class="lead mt2">Nothing here is theory. Four practices, and every framework we publish was
    ...
    <div class="grid g4 mt4">
      ...
      <div>
        ...
        <p class="small mt1" style="color:var(--ink)">What happens to the proceeds, the family and
          the plan after the wire hits.</p>
      </div>
      <div>
        ...
        <p class="small mt1" style="color:var(--ink)">Protection under all of it &mdash; home, auto,
          life and umbrella, plus the key person and buy-sell cover that makes a business
          transferable at all.</p>
      </div>
      <div>
        ...
        <p class="small mt1" style="color:var(--ink)">The family office itself: land, energy and the
          operating portfolio where the systems get stress-tested.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="section">
  <div class="wrap">
    ...
    <p class="lead mt3">Most owners are handed a plan for one of these and left to improvise the
      other two. The trilogy treats life, business, and wealth as a single design integration
      opportunity, because that is how they actually behave.</p>
